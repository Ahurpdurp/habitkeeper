...
function (_React$Component) {
  ...
  _createClass(Month, [{
    ...
    value: function render() {
      ...
      }, !disableDaysOfWeek && _react.default.createElement(_days_of_week.default, {
    ...
    value: function _renderWeeks() {
      ...
      while (typeof minNumberOfWeeks == 'number' && minNumberOfWeeks > weeks.length || (0, _is_before.default)(date, end) || (0, _is_same_day.default)(date, end)) {
        weeks.push(date);
...
_defineProperty(Month, "propTypes", {
  ...
  onNoticeChange: _propTypes.default.func.isRequired,
